...
export default function LandingPageHero() {
  return (
    <div className="w-[1100px] m-auto flex flex-col justify-center items-center gap-4 pt-32">
      ...
      <h1 className="text-6xl font-extrabold text-center w-full leading-[1.3]">
        Empowering Productivity Through Seamless Task Management
      </h1>
      <p className="leading-7 text-xl text-center font-light">
