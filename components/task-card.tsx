    ...
    <div className="p-5 bg-muted rounded-xl shadow-inner flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="line-clamp-3 text-ellipsis">
          Main Context Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Alias tempore debitis distinctio eos odio rem id dolores sequi officia
          reiciendis enim omnis autem voluptatibus illo iure at quasi,
          accusantium maxime!
        </p>
      </div>
      <div className="flex flex-col gap-2">
